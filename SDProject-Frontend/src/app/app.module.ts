...
import { DialogEditDeviceComponent } from './components/dialog-edit-device/dialog-edit-device.component';
import { DialogDeleteDeviceComponent } from './components/dialog-delete-device/dialog-delete-device.component';
